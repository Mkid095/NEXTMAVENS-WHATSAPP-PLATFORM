 ...
 * Helper functions for cache key generation and response serialization
 */
 ...
 */
export function serializeResponse(res: CachedResponse): string {
 ...
 */
export function deserializeResponse(data: string): CachedResponse | null {
  try {
